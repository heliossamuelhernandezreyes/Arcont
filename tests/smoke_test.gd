...
func _init()->void:
 ...
 for method in ["_begin_attack","_telegraph_pose","_resolve_attack","receive_melee_attack","melee_execute","apply_hit","apply_emp","current_attack_line","is_telegraphing"]:_check_script_method("res://scripts/xeno_stalker.gd",method,failures)

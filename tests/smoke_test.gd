...
func _init()->void:
 ...
 _check_scene("res://scenes/main.tscn",["PerformanceBudget","AwarenessDirector","NavigationGraph","CombatFeedback","UrbanDistrict","MissionDirector","ThrowableController","CompanionRobot","Player","Player/BodyVisual","Player/BodyVisual/OperatorModel","Player/BodyVisual/WeaponMount","Player/BodyVisual/WeaponMount/Gun","Player/BodyVisual/WeaponMount/MuzzleFlash","Player/CoverProbe","Player/CameraRig/Camera3D","Player/Weapon","Player/Weapon/VisualAnimator","Player/ThirdPersonADS","Player/TacticalMobility","Player/MeleeCombat","Enemies","HUD/Objective","HUD/WeaponName","HUD/Throwable","HUD/MobileControls"],failures)
 _check_absent("res://scenes/main.tscn",["Player/CameraRig/Camera3D/Gun","Player/CameraRig/Camera3D/Weapon","Player/CameraRig/Camera3D/MuzzleFlash"],failures)
 ...
 for method in ["_camera_target","_apply_camera_collision","is_aiming"]:_check_script_method("res://scripts/third_person_ads.gd",method,failures)
 ...
 for method in ["_build_ground","_build_city","_build_checkpoint","_build_vehicles","_build_props","_build_boundary","_build_points","_spawn_asset","_vehicle"]:_check_script_method("res://scripts/urban_environment.gd",method,failures)
 ...
 for method in ["_ads_center","_weapon_center","_crouch_center","_dodge_center","_melee_center","_melee_label","_command_center","_throw_center","_camera_center","_claim_touch","_action_at","_handle_drag","_release_touch","_bind_weapon_feedback","_draw_active_reload","_on_active_reload_feedback"]:_check_script_method("res://scripts/mobile_controls.gd",method,failures)
 for method in ["_update_generator","_update_defense","_trigger_defense_events","_spawn_brute_event","_request_reinforcements","_request_ranged","_request_xeno","_request_stalker","_collect_supplies","_complete_mission"]:_check_script_method("res://scripts/mission_director.gd",method,failures)
 ...
 for method in ["_apply_skin_recursive","_update_procedural","_quality_interval","_setup_animation_player","_import_clip","_play_state"]:_check_script_method("res://scripts/provisional_character_visual.gd",method,failures)

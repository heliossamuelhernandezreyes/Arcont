...
func _init()->void:
 ...
 _check_scene("res://scenes/main.tscn",["PerformanceBudget","AwarenessDirector","NavigationGraph","CombatFeedback","UrbanDistrict","MissionDirector","ThrowableController","CompanionRobot","Player","Player/BodyVisual","Player/BodyVisual/OperatorModel","Player/CoverProbe","Player/CameraRig/Camera3D/Weapon","Player/ThirdPersonADS","Player/TacticalMobility","Enemies","HUD/Objective","HUD/WeaponName","HUD/Throwable","HUD/MobileControls"],failures)
 for scene_data in [["res://scenes/enemy.tscn",["Collision","Body","Head","ArmL","ArmR"]],["res://scenes/companion_robot.tscn",["Collision","Body","Turret","StatusLight"]],["res://scenes/ranged_enemy.tscn",["Collision","Body","Weapon","EyeLight","NavigationAgent3D"]],["res://scenes/xeno_lancer.tscn",["Collision","Body","Weapon","CoreLight","NavigationAgent3D"]]]:_check_scene(scene_data[0],scene_data[1],failures)
 ...
 for method in ["set_trigger","set_ads","cycle_weapon","switch_weapon","try_fire","_report_weapon_sound","_fire_weapon","_trace_round","request_reload","active_reload_tap","get_active_reload_state","add_ammo","_player_controller","_build_weapon_visual"]:_check_script_method("res://scripts/weapon.gd",method,failures)
 ...
 for method in ["_ads_center","_weapon_center","_crouch_center","_dodge_center","_command_center","_throw_center","_throw_cycle_center","_assign_touch"]:_check_script_method("res://scripts/mobile_controls.gd",method,failures)

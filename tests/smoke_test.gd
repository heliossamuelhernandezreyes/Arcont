...
func _init()->void:
 ...
 for method in ["_build_ground","_build_city","_build_checkpoint","_build_vehicles","_build_props","_build_boundary","_build_points","_add_cover_marker","_spawn_asset","_vehicle","_collision_box","_apply_visibility_range","_bind_performance_budget","_on_visual_budget_changed","_apply_runtime_visibility"]:_check_script_method("res://scripts/urban_environment.gd",method,failures)
 ...
 for method in ["_start_next_wave","spawn_reinforcements","spawn_ranged_enemies","spawn_xeno_lancers","spawn_xeno_stalkers","spawn_brute","_spawn_position_for","_on_performance_profile_changed","_on_visual_budget_changed","_refresh_enemy_visual_budget","_apply_enemy_visual_budget","_apply_enemy_visual_detail_recursive","_on_weapon_changed"]:_check_script_method("res://scripts/main.gd",method,failures)
 ...
 _check_text("res://scripts/urban_environment.gd","district_size:=Vector2(170.0,220.0)",failures);_check_text("res://scripts/urban_environment.gd","building_A.fbx",failures);_check_text("res://scripts/urban_environment.gd","car_police.fbx",failures);_check_text("res://scripts/urban_environment.gd","VISIBILITY_RANGE_FADE_DISABLED",failures);_check_text("res://scripts/urban_environment.gd","cover_points.append_array",failures)
 ...
 _check_text("res://scripts/performance_budget.gd","signal visual_budget_changed",failures);_check_text("res://scripts/main.gd","budget.visual_budget_changed.connect(_on_visual_budget_changed)",failures);_check_text("res://scripts/main.gd","SHADOW_CASTING_SETTING_OFF",failures)

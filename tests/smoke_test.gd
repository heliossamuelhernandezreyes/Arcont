...
func _init()->void:
 ...
 _check_scene("res://scenes/main.tscn",["PerformanceBudget","AwarenessDirector","NavigationGraph","CombatFeedback","UrbanDistrict","MissionDirector","ThrowableController","CompanionRobot","Player","Player/BodyVisual","Player/BodyVisual/OperatorModel","Player/CoverProbe","Player/CameraRig/Camera3D/Weapon","Player/CameraRig/Camera3D/Weapon/VisualAnimator","Player/ThirdPersonADS","Player/TacticalMobility","Enemies","HUD/Objective","HUD/WeaponName","HUD/Throwable","HUD/MobileControls"],failures)
 ...
 for method in ["_ads_center","_weapon_center","_crouch_center","_dodge_center","_command_center","_throw_center","_throw_cycle_center","_assign_touch","_bind_weapon_feedback","_draw_active_reload","_on_active_reload_feedback"]:_check_script_method("res://scripts/mobile_controls.gd",method,failures)

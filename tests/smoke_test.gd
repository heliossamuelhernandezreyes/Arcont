...
func _init()->void:
 ...
 _check_scene("res://scenes/main.tscn",["PerformanceBudget","AwarenessDirector","NavigationGraph","CombatFeedback","UrbanDistrict","MissionDirector","ThrowableController","CompanionRobot","Player","Player/BodyVisual","Player/BodyVisual/OperatorModel","Player/BodyVisual/WeaponMount","Player/BodyVisual/WeaponMount/Gun","Player/BodyVisual/WeaponMount/MuzzleFlash","Player/CoverProbe","Player/CameraRig/SpringArm3D","Player/CameraRig/SpringArm3D/Camera3D","Player/Weapon","Player/Weapon/VisualAnimator","Player/ThirdPersonADS","Player/TacticalMobility","Player/MeleeCombat","Enemies","HUD/Objective","HUD/WeaponName","HUD/Throwable","HUD/MobileControls"],failures)

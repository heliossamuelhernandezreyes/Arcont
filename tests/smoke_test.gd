...
func _init()->void:
 ...
 for method in ["_configure_personality","_begin_engagement","_choose_sequence","_begin_sequence","_commit_feint","_begin_combo_strike","_update_sidestep","_telegraph_pose","_telegraph_pose_for","_resolve_attack","receive_melee_attack","melee_execute","apply_hit","apply_emp","current_attack_line","is_telegraphing","is_feinting","current_combo_step","get_combat_personality"]:_check_script_method("res://scripts/xeno_stalker.gd",method,failures)

...
func _build_props()->void:
 for p in [Vector3(-9,0.15,-82),Vector3(9,0.15,-58),Vector3(-9,0.15,-5),Vector3(9,0.15,18),Vector3(-9,0.15,48),Vector3(9,0.15,76)]:_spawn_asset(PROP_MODELS["bench"],p,Vector3(0,90,0),Vector3.ONE,prop_visibility_range)
 for p in [Vector3(6,0.15,-70),Vector3(-7,0.15,-36),Vector3(6,0.15,8),Vector3(-7,0.15,31),Vector3(8,0.15,64)]:_spawn_asset(PROP_MODELS["box_a"],p,Vector3.ZERO,Vector3.ONE,prop_visibility_range)

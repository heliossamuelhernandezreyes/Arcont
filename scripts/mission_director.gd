...
func _generator_activated() -> void:
	...
	info_label.text = "ARCONT // DISTRITO DE EVACUACION 07\nENERGIA RESTAURADA · FIRMA HOSTIL EN AUMENTO"
...
func _defense_complete() -> void:
	...
	info_label.text = "ARCONT // SEÑAL ESTABILIZADA\nSUMINISTROS DE EMERGENCIA LOCALIZADOS"
...
func _collect_supplies() -> void:
	...
	info_label.text = "ARCONT // PAQUETE RECUPERADO\nVENTANA DE EXTRACCION ABIERTA"
...
func _complete_mission() -> void:
	...
	info_label.text = "ARCONT // OPERADOR EXTRAIDO\nDISTRITO 07 PERDIDO · DATOS RECUPERADOS"
	if evac_light:
